statusColours <- c("secondsInColumns.Open" = "white", "secondsInColumns.Backlog" = "white",
 ...
 "secondsInColumns.Implementation.Done" = "white","secondsInColumns.Demo.d" = "white",
                   ...
                   "secondsInColumns.Functional.Test.Deployment.In" = "#00bb00",
                   ...
                   "secondsInColumns.Regression.Test.Deployment.In" = "#007700",
                   "secondsInColumns.UAT.Test.Deployment.In" = "#007700",
                   ...
                   "secondsInColumns.Regression.In" = "#ddffdd",
                   "secondsInColumns.Regression.Done" = "white",


                   "secondsInColumns.Ready.For.Release" = "#55bb55",
