...
tsTickets <- read.csv(datasetFile, header=T, skipNul=T, na.strings="") %>%
  ...
  select( -totalTime, -spend, -starts_with("leftColumnDate"), -one_of(c("secondsInColumns.Open", "secondsInColumns.New", "secondsInColumns.Next.Up", "secondsInColumns.Backlog", "secondsInColumns.Resolved", "secondsInColumns.Reopened", "secondsInColumns.Closed", "secondsInColumns.Done", "secondsInColumns.Coming.Next"))) 
